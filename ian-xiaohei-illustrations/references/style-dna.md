...
- 生成前读取 `assets/rongbao.png`，只把它当作绒宝身份参考，不把它当作背景或材质参考。
- 保留黄色圆形主体、两片青绿色叶耳、棕黑大眼、橙色腮红和橙色手脚；用简洁轮廓、黑色手绘线条和少量平涂色块表现。
- 参考图的 3D 绒毛、米色背景、渐变、阴影和摄影棚光照不属于本 Skill 的风格，成图必须回到纯白、极简、手绘体系。
